...
class ewdupcpAdminProductPage {
						...
						<ul>
							...
							<?php foreach ( $elements as $element ) { ?>
								...
								<li>
									...
									<a class='ewd-upcp-custom-product-page-add-element' data-name='<?php echo $element->name; ?>' data-class='<?php echo $element->class; ?>' data-id='<?php echo $element->id; ?>' data-x_size='<?php echo $element->x_size; ?>' data-y_size='<?php echo $element->y_size; ?>'><?php echo $element->name; ?></a>
						...
						<div class='wrapper gridster gridster-large'>
							...
							<ul>
								...
								<?php foreach ( $gridster as $grid_element ) { ?>
									...
									<li data-col='<?php echo $grid_element->col; ?>' data-row='<?php echo $grid_element->row; ?>' data-sizex='<?php echo $grid_element->size_x; ?>' data-sizey='<?php echo $grid_element->size_y; ?>'  data-elementclass='<?php echo $grid_element->element_class; ?>' data-elementid='<?php echo $grid_element->element_id; ?>' class='prod-page-div gs-w' style='display: list-item; position:absolute;'>
										...
										<?php if ( $grid_element->element_class == 'text' ) { ?>
											...
											<textarea class='ewd-upcp-pb-textarea'>
												<?php echo $grid_element->element_id; ?>
											</textarea>
						...
						<ul>
							...
							<?php foreach ( $elements as $element ) { ?>
								...
								<li>
									...
									<a class='ewd-upcp-custom-product-page-add-element' data-name='<?php echo $element->name; ?>' data-class='<?php echo $element->class; ?>' data-x_size='<?php echo $element->x_size; ?>' data-y_size='<?php echo $element->y_size; ?>'><?php echo $element->name; ?></a>
	...
	public function save_gridster_layout() {
		...
		update_option( $option_name, stripslashes_deep( $_POST['serialized_product_page'] ) );
	}
