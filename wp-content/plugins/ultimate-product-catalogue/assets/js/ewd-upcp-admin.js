...
jQuery( document ).ready( function() { console.log( ewd_upcp_php_admin_data );

	if ( ewd_upcp_php_admin_data == undefined || ewd_upcp_php_admin_data.product_add ) { return; }
...
jQuery(function(){ //DOM Ready
	...
	jQuery( '.gridster-mobile-save' ).on( 'click', function( event ) {
		...
		var data = 'serialized_product_page=' + JSON.stringify( serialized ) + '&action=ewd_upcp_save_serialized_product_page&type=mobile';
		jQuery.post( ajaxurl, data, function( response ) {
							
			jQuery( '.gridster-mobile-save' ).before( '<div class="ewd-upcp-gridster-response">Layout Saved!</div>' );
	...
	jQuery( '.gridster-large-save' ).on( 'click', function( event ) {
		...
		var data = 'serialized_product_page=' + JSON.stringify( serialized ) + '&action=ewd_upcp_save_serialized_product_page&type=large';
		jQuery.post( ajaxurl, data, function( response ) {
							
			jQuery( '.gridster-large-save' ).before( '<div class="ewd-upcp-gridster-response">Layout Saved!</div>' );
