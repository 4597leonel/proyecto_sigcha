	...
	jQuery.post( ajaxurl, data, function( response ) {
		...
		if ( response.data.request_count != request_count ) { return; } 
			...
			if ( infinite_scroll_loading ) {
				...
				jQuery( '.ewd-upcp-list-view' ).append( response.data.list_view ? response.data.thumbnail_view : ewd_upcp_php_data.no_results_found_label );
				jQuery( '.ewd-upcp-detail-view' ).append( response.data.detail_view ? response.data.thumbnail_view : ewd_upcp_php_data.no_results_found_label );
			}
			else {
				...
				jQuery( '.ewd-upcp-list-view' ).html( response.data.list_view ? response.data.thumbnail_view : ewd_upcp_php_data.no_results_found_label );
				jQuery( '.ewd-upcp-detail-view' ).html( response.data.detail_view ? response.data.thumbnail_view : ewd_upcp_php_data.no_results_found_label );
			}
...
function ewd_upcp_get_request_string_and_set_history() {
	...
	jQuery( '.ewd-upcp-catalog-sidebar-custom-field select' ).each( function() { 
