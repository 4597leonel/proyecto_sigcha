...
class ewdupcpViewProduct extends ewdupcpView {
	 ...
	 */
  	public function set_catalog_links() {
  		...
  		elseif ( $ewd_upcp_controller->settings->get_setting( 'woocommerce-product-page' ) ) { $this->details_link = add_query_arg( 'ewd_upcp_catalog_url', $this->catalog_url, get_permalink( $this->product->woocommerce_id ) ); }
