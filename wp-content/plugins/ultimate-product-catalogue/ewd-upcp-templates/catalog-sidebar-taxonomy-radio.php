<div class='ewd-upcp-catalog-sidebar-<?php echo $this->taxonomy_type; ?> <?php echo ( $this->is_taxonomy_selected() ? 'ewd-upcp-taxonomy-selected' : '' ); ?>' data-taxonomy_id='<?php echo $this->taxonomy_term->term_id; ?>'>
	...
	<input type='radio' name='<?php echo $this->taxonomy_type; ?>' value='<?php echo $this->taxonomy_term->term_id; ?>' <?php echo ( $this->is_taxonomy_selected() ? 'checked' : '' ); ?> >

	<label class='ewd-upcp-catalog-sidebar-taxonomy-label'> 
